...
void DepthPass(ShadowMapVsmOrthogonalRenderData& data)
{
...
void RenderPass(ShadowMapVsmOrthogonalRenderData& data)
{
...
void DebugPass(ShadowMapVsmOrthogonalRenderData& data)
{
