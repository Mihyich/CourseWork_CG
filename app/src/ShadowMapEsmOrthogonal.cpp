...
void DepthPass(ShadowMapEsmOrthogonalRenderData& data)
{
...
void RenderPass(ShadowMapEsmOrthogonalRenderData& data)
{
...
void DebugPass(ShadowMapEsmOrthogonalRenderData& data)
{
...
void ShadowMapEsmOrthogonal(ShadowMapEsmOrthogonalRenderData& data)
{
    DepthPass(data);
    RenderPass(data);
}

void ShadowMapEsmOrthogonalDebug(ShadowMapEsmOrthogonalRenderData& data)
{
    DepthPass(data);
    DebugPass(data);
}