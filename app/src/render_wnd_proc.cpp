...
LRESULT RenderWndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    static Shader shader_SM_PCSS_NOISE_O_DP; // ShadowMap (PCSS_NOISE) Orthogonal Depth Pass
    static Shader shader_SM_PCSS_NOISE_O_RP; // ShadowMap (PCSS_NOISE) Orthogonal Render Pass

    static Shader shader_SM_PCSS_NOISE_P_DP; // ShadowMap (PCSS_NOISE) Perspective Depth Pass
    static Shader shader_SM_PCSS_NOISE_P_RP; // ShadowMap (PCSS_NOISE) Perspective Render Pass
    ...
    case WM_INIT_GL_OPTIONS:
    {
        ...
        shader_SM_PCSS_NOISE_P_DP.create_from_file("Shaders/ShadowMapPCSS_NOISE (perspective)/DepthPass/frag.glsl", GL_FRAGMENT_SHADER);
        shader_SM_PCSS_NOISE_P_DP.link_program();
        shader_SM_PCSS_NOISE_P_DP.init_uniforms_blocks_attribs();
        shader_SM_PCSS_NOISE_P_DP.print_uniforms_blocks_attribs();
        shader_SM_PCSS_NOISE_P_DP.report(REPORT_VS | REPORT_FS | REPORT_PROG);
        shader_SM_PCSS_NOISE_P_DP.delete_shader(GL_VERTEX_SHADER);
        shader_SM_PCSS_NOISE_P_DP.delete_shader(GL_FRAGMENT_SHADER);

        shader_SM_PCSS_NOISE_P_RP.set_shader_name("Shaders/ShadowMapPCSS_NOISE (perspective)/RenderPass");
        shader_SM_PCSS_NOISE_P_RP.create_from_file("Shaders/ShadowMapPCSS_NOISE (perspective)/RenderPass/vert.glsl", GL_VERTEX_SHADER);
        shader_SM_PCSS_NOISE_P_RP.create_from_file("Shaders/ShadowMapPCSS_NOISE (perspective)/RenderPass/frag.glsl", GL_FRAGMENT_SHADER);
        shader_SM_PCSS_NOISE_P_RP.link_program();
        shader_SM_PCSS_NOISE_P_RP.init_uniforms_blocks_attribs();
        shader_SM_PCSS_NOISE_P_RP.print_uniforms_blocks_attribs();
        shader_SM_PCSS_NOISE_P_RP.report(REPORT_VS | REPORT_FS | REPORT_PROG);
        shader_SM_PCSS_NOISE_P_RP.delete_shader(GL_VERTEX_SHADER);
        shader_SM_PCSS_NOISE_P_RP.delete_shader(GL_FRAGMENT_SHADER);
        ...
        ProgrammId = shader_SM_PCSS_NOISE_P_RP.getProgramId();
        blockIndex = glGetUniformBlockIndex(ProgrammId, "Lighting");
        glUniformBlockBinding(ProgrammId, blockIndex, 0);
