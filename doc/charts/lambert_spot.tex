...
\begin{tikzpicture}[y=1cm, x=1cm, yscale=\globalscale,xscale=\globalscale, every node/.append style={scale=\globalscale}, inner sep=0pt, outer sep=0pt]
  ...
  \path[draw=black,fill=white,rounded corners=0.8cm] (0.0, 20.2406) rectangle (3.175, 18.6531);
  ...
  \end{scope}
  \path[draw=black,fill=white,rounded corners=0.8cm] (0.0, 1.614) rectangle (3.175, 0.0265);
