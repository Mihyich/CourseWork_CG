...
BOOL gl_init_extensions()
{
    ...
    OPENGL_GET_PROC_WITH_TRHOW(PFNGLBINDIMAGETEXTUREPROC, glBindImageTexture);
    // Объект массива вершин
    ...
    OPENGL_GET_PROC_WITH_TRHOW(PFNGLDISPATCHCOMPUTEPROC, glDispatchCompute);
    OPENGL_GET_PROC_WITH_TRHOW(PFNGLMEMORYBARRIERPROC, glMemoryBarrier);
