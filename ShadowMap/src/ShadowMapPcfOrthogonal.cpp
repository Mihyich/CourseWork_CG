...
void DepthPass(ShadowMapPcfOrthogonalRenderData& data)
{
...
void RenderPass(ShadowMapPcfOrthogonalRenderData& data)
{
...
void DebugPass(ShadowMapPcfOrthogonalRenderData& data)
{
