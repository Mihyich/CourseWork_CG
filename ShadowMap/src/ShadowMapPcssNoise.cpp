...
void DepthPass(ShadowMapPcssNoiseRenderData& data)
{
...
void RenderPass(ShadowMapPcssNoiseRenderData& data)
{
...
void DebugPass(ShadowMapPcssNoiseRenderData& data)
{
...
void ShadowMapPcssNoise(ShadowMapPcssNoiseRenderData& data)
{
    DepthPass(data);
    RenderPass(data);
}

void ShadowMapPcssNoiseDebug(ShadowMapPcssNoiseRenderData& data)
{
    DepthPass(data);
    DebugPass(data);
}