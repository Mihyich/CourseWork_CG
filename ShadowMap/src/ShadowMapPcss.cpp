...
void DepthPass(ShadowMapPcssRenderData& data)
{
...
void RenderPass(ShadowMapPcssRenderData& data)
{
...
void DebugPass(ShadowMapPcssRenderData& data)
{
...
void ShadowMapPcss(ShadowMapPcssRenderData& data)
{
    DepthPass(data);
    RenderPass(data);
}

void ShadowMapPcssDebug(ShadowMapPcssRenderData& data)
{
    DepthPass(data);
    DebugPass(data);
}